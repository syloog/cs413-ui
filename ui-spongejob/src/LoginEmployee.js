...
const LoginEmployee = ( { showRegisterLink }) => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch(`http://localhost:8080/employee?username=${usernamePassword.username}&password=${usernamePassword.password}`,{
            method: "GET",
            headers: {
                        ...
                        <Grid.Row columns="equal" centered>
                            <Grid.Column width={8}>
                                ...
                                >
                                    ...
                                    <Button.Group fluid>
                                    <Button as = {Link} to="/registeremployee"> Open an account </Button>
