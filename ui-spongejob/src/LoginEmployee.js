...
const LoginEmployee = ({ showRegisterLink }) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(
      `http://127.0.0.1:8080/employee/${usernamePassword.username}/${usernamePassword.password}`,
      {
        method: "GET",
        headers: {
      ...
      .then((result) => {
        ...
        fetch(`http://127.0.0.1:8080/employee/${data}`, {
          method: "GET",
          headers: {
            "Content-Type": "application/raw",
          },
          ...
          .then((result) => {
            ...
            const {firstname, surname, age, cv, email, employeeId, phone} = result;

            UserProfile.createProfile(firstname, surname, phone, email, age, cv, employeeId);
          ...
          <Grid.Row columns="equal" centered>
            <Grid.Column width={8}>
              ...
              >
                ...
                <Button.Group fluid>
                  <Button as={Link} to="/registeremployee">
                    {" "}
                    Open an account{" "}
                  </Button>
